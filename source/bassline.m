...
function [correctRate, lengthSong, misses, player] = bassline(DEBUG, SINGLE, ISORDER, ISPLOT, MINDIST, MINHEIGHT, MINPROM, ROOT)
...
if DEBUG == 0
    ...
    for i = 1:1:length(files)  
        ...
        [bass, player] = singlebass([ROOT files(i).name], DEBUG, ISPLOT, MINHEIGHT, MINDIST, MINPROM);
...
if DEBUG == 1
    ...
    [bass, player] = singlebass([ROOT files(SINGLE).name], DEBUG, ISPLOT, MINHEIGHT, MINDIST, MINPROM);
    lengthSong = 1;
