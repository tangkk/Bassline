...
function [correctRate, lengthSong, misses, player] = bassline(DEBUG, SINGLE, ISORDER, MINDIST, MINHEIGHT, MINPROM, ROOT)
...
if DEBUG == 0
    ...
    for i = 1:1:length(files)  
        ...
        [bass, player] = singlebass([ROOT files(i).name], DEBUG, MINHEIGHT, MINDIST, MINPROM);
...
if DEBUG == 1
    ...
    [bass, player] = singlebass([ROOT files(SINGLE).name], DEBUG, MINHEIGHT, MINDIST, MINPROM);
    lengthSong = 1;
